module "policy_condenser" {
  ...
  input_policies = [
    ...
    "${data.aws_iam_policy_document.iam_manage_mfa.*.json}",
    "${data.aws_iam_policy_document.iam_list_users.*.json}",
    "${data.aws_iam_policy_document.iam_list_groups_for_user.*.json}",
    ...
    "${data.aws_iam_policy_document.ses_full_access.*.json}",
    "${data.aws_iam_policy_document.ses_send_raw_email.*.json}",
